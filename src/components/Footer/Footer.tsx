  ...
  return (
    <footer className="footer  pt-5">
      <div className="container-fluid pt-5">
          ...
          <div className="d-flex justify-content-between flex-wrap">
            ...
            <div className="d-flex flex-wrap">
              ...
              Contact Us
                ...
                <p className="text-family-SF-Pro-text">
                  <FaMapMarkerAlt className="contact-icon" /> Via 3, 1-00, Zona
                  4, Edificio Tec 3
                  <br />
        ...
        <div className="mt-4 ">
          <div className="container pb-3 pt-3 d-flex align-items-center justify-content-center border-top">
            <div className="text-left d-flex flex-wrap-reverse align-items-center w-100 justify-content-between ">
              <p className="text-family-SF-Pro-text p-0 m-0 ">
